...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\anubh\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.515\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '205ac2e84faf074e8ccbbeAE9SAlEWBVwAUwlRUVYLAAFRVFAH', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/anubh/.vscode/extensions/wallabyjs.console-ninja-1.0.515/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '205ac2e84faf074e8ccbbeAE9SAlEWBVwAUwlRUVYLAAFRVFAH', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

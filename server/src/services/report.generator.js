...
/* ───────────────── FONT & ASSETS ───────────────── */
const FONT_PATH = path.join(ASSETS_DIR, "fonts/NotoSans-Regular.ttf");
const FRAMEWORK_IMG_PATH = path.join(ASSETS_DIR, "stream-framework.png");
const PROFESSIONS_IMG_PATH = path.join(ASSETS_DIR, "professions.png");
const STUDENT_PHOTO_PATH = path.join(ASSETS_DIR, "student-profile.png");
const HEADER_BG_IMG_PATH = path.join(ASSETS_DIR, "header-background.jpg");
const CAREER_COUNSELLING_IMG_PATH = path.join(ASSETS_DIR, "career-counselling.jpg");

/* ───────────────── COVER PAGE ASSETS ───────────────── */
// REMOVED: cover-illustration.png - no longer used
const COVER_LOGO_PATH = path.join(ASSETS_DIR, "logo (2).png");
...
/* ───────────────── CAREER ICONS ───────────────── */
const CAREER_ICONS = {
  medical: path.join(ASSETS_DIR, "icons/medical.png"),
  engineering: path.join(ASSETS_DIR, "icons/engineering.png"),
  law: path.join(ASSETS_DIR, "icons/law.png"),
  business: path.join(ASSETS_DIR, "icons/business.png"),
  arts: path.join(ASSETS_DIR, "icons/arts.png"),
  science: path.join(ASSETS_DIR, "icons/science.png"),
  technology: path.join(ASSETS_DIR, "icons/technology.png"),
  finance: path.join(ASSETS_DIR, "icons/finance.png"),
  education: path.join(ASSETS_DIR, "icons/education.png"),
  design: path.join(ASSETS_DIR, "icons/design.png"),
  hospitality: path.join(ASSETS_DIR, "icons/hospitality.png"),
  armed: path.join(ASSETS_DIR, "icons/armed.png"),
  default: path.join(ASSETS_DIR, "icons/career.png"),
};
...
/* ───────────────── SECTION ICONS ───────────────── */
const SECTION_ICONS = {
  careerIndia: path.join(ASSETS_DIR, "icons/india-flag.png"),
  careerAbroad: path.join(ASSETS_DIR, "icons/globe.png"),
  fees: path.join(ASSETS_DIR, "icons/fees.png"),
  salary: path.join(ASSETS_DIR, "icons/salary.png"),
  institutes: path.join(ASSETS_DIR, "icons/institutes.png"),
  roadmap: path.join(ASSETS_DIR, "icons/roadmap.png"),
};

/* ───────────────── PERSONALITY PAGE ICONS ───────────────── */
const PERSONALITY_HEADER_ICON = path.join(ASSETS_DIR, "icons/personality.png");

const PERSONALITY_SECTION_ICONS = {
  COGNITIVE: path.join(ASSETS_DIR, "icons/cognitive.png"),
  NUMERACY: path.join(ASSETS_DIR, "icons/numeracy.png"),
  ACADEMIC: path.join(ASSETS_DIR, "icons/academic.png"),
  VERBAL: path.join(ASSETS_DIR, "icons/verbal.png"),
  INTEREST: path.join(ASSETS_DIR, "icons/interest.png"),
  DISCIPLINE: path.join(ASSETS_DIR, "icons/discipline.png"),
  RISK: path.join(ASSETS_DIR, "icons/risk.png"),
  FINANCE: path.join(ASSETS_DIR, "icons/finance-personality.png"),
};
...
const INNER_CARD_ICONS = {
  meaning: path.join(ASSETS_DIR, "icons/meaning.png"),
  analysis: path.join(ASSETS_DIR, "icons/analysis.png"),
  developmentplan: path.join(ASSETS_DIR, "icons/developmentplan.png"),
  actionplan: path.join(ASSETS_DIR, "icons/actionplan.png"),
};
//******************************************************************************************** */
...
const drawHeader = (doc, margins, width, height, studentPhotoPath = null) => {
  ...
  if (fs.existsSync(photoPath)) {
    ...
    const LOGO_PATH = path.join(ASSETS_DIR, "logo (2).png");
